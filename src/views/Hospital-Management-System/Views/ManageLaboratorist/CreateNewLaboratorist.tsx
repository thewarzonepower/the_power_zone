...
const OnboardNewLaboratorist: React.FC<Props> = ({
    open,
    setOpen
}) => {
    return (
                ...
                <ModalDialog>
                    ...
                    >
                        <Grid container spacing={2} flexDirection="row">
                            ...
                            <Grid xs={12} sm={12} md={12} xl={12} lg={12} sx={{display:"flex",justifyContent:"center"}}>
...
export default OnboardNewLaboratorist